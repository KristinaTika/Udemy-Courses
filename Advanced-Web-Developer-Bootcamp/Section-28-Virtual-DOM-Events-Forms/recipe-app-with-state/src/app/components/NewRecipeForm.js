...
class NewRecipeForm extends Component {
  ...
  handleSubmit(e) {
    e.preventDefault();
    this.props.onSave({ ...this.state }); // pozivamo difoltnu onSave metodu i prosledjujemo joj kopiju svih propertija u stejtu;
    this.setState({
      title: "",
      instructions: "",
      ingredients: [""],
    ...
    return (
      <div className="recipe-form-container">
        <form className='recipe-form' onSubmit={this.handleSubmit}>
          <button type="button" className="close-button" onClick={this.handleClose}>X</button>
          ...
          <div className='recipe-form-line'>
            ...
            <input id='recipe-img-input' type='text' placeholder='' name='img' value={img} size={36} autoComplete='off' onChange={this.handleChange} />
          </div>
